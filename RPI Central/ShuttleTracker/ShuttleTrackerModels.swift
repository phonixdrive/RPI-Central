...
struct ShuttleVehicleETA: Identifiable {
    let id: String
    let timestamp: Date?
    let stopTimes: [String: Date]
}
...
struct ShuttleETAPayload: Decodable {
...
struct ShuttleRoutePayload: Decodable {
    ...
    func makeOverlay(routeName: String) -> ShuttleRouteOverlay {
        ...
        return ShuttleRouteOverlay(
            ...
            isHidden: ShuttleRoutePayload.isHiddenRouteColor(colorHex)
        )
    }

    private static func isHiddenRouteColor(_ hex: String) -> Bool {
