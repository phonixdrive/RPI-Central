...
struct SocialHubView: View {
                ...
                if groupsExpanded {
                    ...
                    if let campusWideChat {
                        ...
                        VStack(alignment: .leading, spacing: 10) {
                            ...
                            chatActionButton("Open chat", unread: hasUnread) {
    ...
    private func chatActionButton(_ title: String, unread: Bool, action: @escaping () -> Void) -> some View {
        Button(action: action) {
                    ...
                    VStack(spacing: 9) {
                        Circle()
                            .fill(
                                LinearGradient(
                                    colors: [
                                        calendarViewModel.themeColor.opacity(0.28),
                                        calendarViewModel.themeColor.opacity(0.10),
                                    ],
                                    startPoint: .topLeading,
                                    endPoint: .bottomTrailing
                                )
                        ...
                        Label(relationshipLabel, systemImage: relationshipIcon)
                            .font(.caption.weight(.semibold))
                            .foregroundStyle(isFriend ? Color.green : calendarViewModel.themeColor)
